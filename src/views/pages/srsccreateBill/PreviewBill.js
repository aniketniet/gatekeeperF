  ...
  useEffect(() => {
    ...
    const fetchBill = async () => {
      try {
        ...
        setMyBill(response.data.data.bill_id); // Store the fetched bill data
      } catch (error) {
  ...
  return (
    ...
    <div className="invoice-card">
      <div className="invoice-title">
        ...
        <span id="invoice-number">#{myBill || 'N/A'}</span>
      </div>
      ...
      <div className="invoice-material-type text-dark">
        ...
        <p className='text-center'><strong>Generated by: </strong>{billerName}</p>
      </div>
